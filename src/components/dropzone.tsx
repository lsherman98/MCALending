...
import { useDropzone as rootUseDropzone, type Accept, type FileRejection } from "react-dropzone";
...
interface DropzoneRemoveFileProps extends ComponentProps<"button"> {}
...
interface DropzoneRetryFileProps extends ComponentProps<"button"> {}
