  ...
  return (
    <div className="flex flex-col gap-2 p-2">
      <div className="flex gap-2 max-h-[400px]">
        <Card className="w-2/5 py-0 flex flex-col">
          <CardHeader className="flex flex-col items-stretch border-b !p-0 flex-shrink-0">
            <div className="flex flex-1 flex-col justify-center gap-1 px-4 py-3">
              ...
              <CardDescription className="text-xs">Monthly transaction totals by type</CardDescription>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
        <Card className="w-full">
          <CardHeader className="flex items-center gap-2 space-y-0 border-b">
            <div className="grid flex-1 gap-1">
              <CardTitle className="text-base">Monthly Balance Overview</CardTitle>
        ...
        <Card className="w-full">
          <CardHeader className="p-3 pb-2 flex-shrink-0">
            ...
            <CardDescription className="text-xs">Distribution of transaction types</CardDescription>
          </CardHeader>
          <CardContent className="p-3 pt-0">
